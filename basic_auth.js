...
function basicAuth(req, res, next) {
  ...
  if (!authHeader) {
    ...
    return res
      .status(401)
      .send(
        `Authentication required. Hint: Add "Authorization" header with value "Basic <base64(username:password)>"\n` +
        `Ví dụ: Authorization: Basic YWRtaW46MTIzNDU= (tương ứng admin:12345)`
      );
  }
