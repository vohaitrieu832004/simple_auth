...
app.post("/login", async (req, res) => {
  ...
  // ✅ thêm hint để hiển thị cookie
  res.send({
    message: "Logged in!",
    hint: "Cookie 'auth_cookie_token' has been set. You can check it in browser DevTools → Application → Cookies.",
    cookie_token: cookie_token   // ⚠ chỉ để demo, thực tế KHÔNG nên trả về
  });
});
